...
*Настрій:* Спокійний, м'який.

**Висновок:** Для додатку я б обрав варіант Muted. Яскраві кольори це круто, але читати з них важко, а приглушені тони не напружують очі користувача.

## 4. Створення градієнта (Extract Gradient)
![Gradient](images/Gradient.png)
*Опис:* Adobe Color автоматично зробив градієнт по трьох точках: плавний перехід від темного фону до світлого жовтого акценту.

## 5. Аналіз контрасту (Accessibility Tools)

Я взяв кольори з монохромної палітри, щоб перевірити, чи можна ними писати текст.
...
* **Висновок:** Коли я зробив колір тексту світлішим, контраст став нормальним. Тепер написи читаються легко і відповідають стандартам.
