...
## Висновки
Під час виконання роботи було встановлено, що сучасні формати, такі як **AVIF** та **WebP**, значно перевершують класичні JPEG та PNG за ефективністю стиснення.
1.  **AVIF** є лідером для всіх типів зображень, дозволяючи зменшити вагу файлу в 3-20 разів без видимої втрати якості.
2.  **Якість 100%** у lossy-форматах є нераціональною, оскільки часто збільшує вагу файлу вище оригіналу.
3.  **Resize** (зміна розміру) є критично важливим етапом оптимізації для мобільних пристроїв, дозволяючи економити найбільше трафіку.
